...
$config['base_url'] = 'http://localhost/monev_iki/';
$config['index_page'] = '';
...
$config['encryption_key'] = 'CakRos';
$config['sess_driver'] = 'files';
$config['sess_cookie_name'] = '_monev_swk';
...
$config['csrf_token_name'] = 'csrf_monev_swk';
$config['csrf_cookie_name'] = 'csrf_cookie_monev_swk';

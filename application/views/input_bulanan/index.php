        ...
        <div class="container-fluid">
            <div class="row mb-2 align-items-center">
                ...
                <div class="col-sm-5 text-right">
                    <span id="badgeBulan" class="badge badge-primary px-3 py-2 mr-1" style="font-size:.8rem;display:none;"></span>
                    <span id="badgeKecamatan" class="badge badge-secondary px-3 py-2" style="font-size:.8rem;display:none;"></span>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="content">
        <div class="container-fluid">
                ...
                <div class="card-body py-3">
                    <div class="row align-items-end">
                        <div class="col-md-3 mb-2">
                            ...
                            <select id="pilihKecamatan" class="form-control select2">
                        ...
                        <div class="col-md-3 mb-2">
                            <label class="small font-weight-bold text-muted mb-1">BULAN INPUT (PER BULAN)</label>
                            <input type="month" id="pilihBulan" class="form-control" value="<?= date('Y-m'); ?>">
                        </div>
            ...
            <div id="summaryRow" class="row" style="display:none;">
                <div class="col-md-4 mb-3">
                    <div class="info-box bg-gradient-teal shadow-sm mb-0">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Industri Rumahan Aktif</span>
                ...
                <div class="col-md-4 mb-3">
                    <div class="info-box bg-gradient-success shadow-sm mb-0">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Total Omset Bulan Terpilih</span>
                            <span class="info-box-number" id="totalOmsetKec">Rp 0</span>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    <div class="info-box bg-gradient-info shadow-sm mb-0">
                        ...
                        <div class="info-box-content">
                            <span class="info-box-text">Total Kunjungan / Transaksi Bulan Ini</span>
                            <span class="info-box-number" id="totalKunjunganKec">0 orang</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="loadingState" class="text-center py-5" style="display:none;">
                ...
                <p class="mt-3 text-muted small">Memuat data industri rumahan kecamatan…</p>
            </div>

            <!-- Empty -->
            <div id="emptyState" class="text-center py-5">
                <i class="fa fa-file-excel fa-4x text-muted mb-3 d-block"></i>
                <p class="text-muted">Pilih Kecamatan &amp; Bulan Input, lalu klik <strong>Tampilkan Data</strong> atau <strong>Upload Excel</strong>.</p>
            </div>

            <!-- Nav Tab Omset / Kunjungan Bulanan -->
                ...
                <ul class="nav nav-tabs mb-0" id="tabInput">
                    <li class="nav-item">
                        <a class="nav-link active font-weight-bold" data-toggle="tab" href="#tabOmset">
                            <i class="fa fa-money-bill-wave mr-1 text-success"></i>Omset Bulanan
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link font-weight-bold" data-toggle="tab" href="#tabKunjungan">
                            <i class="fa fa-users mr-1 text-info"></i>Kunjungan / Transaksi Bulanan
                        </a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="tabOmset">
                        <div class="card card-success card-outline shadow-sm mb-0" style="border-top:0;">
                            <div class="card-header d-flex justify-content-between align-items-center py-2">
                                <span class="font-weight-bold small text-muted"><i class="fa fa-info-circle mr-1"></i>Data omset bulanan per industri rumahan di kecamatan</span>
                    ...
                    <div class="tab-pane fade" id="tabKunjungan">
                        <div class="card card-info card-outline shadow-sm mb-0" style="border-top:0;">
                            <div class="card-header d-flex justify-content-between align-items-center py-2">
                                <span class="font-weight-bold small text-muted"><i class="fa fa-info-circle mr-1"></i>Data transaksi / kunjungan bulanan per industri rumahan</span>
...
<!-- ═══ MODAL PANDUAN PENGGUNAAN BULANAN (KECAMATAN) ═══ -->
<div class="modal fade" id="modalPanduan" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header bg-info text-white py-2">
                <h6 class="modal-title font-weight-bold"><i class="fa fa-book-reader mr-2"></i>Panduan Pengisian &amp; Upload Excel Bulanan Kecamatan</h6>
            ...
            <div class="modal-body p-4">
                <div class="alert alert-warning border-left py-2 mb-4" style="border-left: 4px solid #ffc107 !important;">
                    <div class="font-weight-bold text-dark mb-1">
                        <i class="fa fa-exclamation-triangle text-warning mr-1"></i> ATURAN PENTING PENGISIAN FILE EXCEL BULANAN:
                    </div>
                    <ul class="mb-0 text-dark pl-3" style="font-size:.85rem;">
                        <li>HANYA isi atau ubah nominal pada kolom <strong>omset</strong> dan <strong>kunjungan</strong>.</li>
                        <li><strong class="text-danger">DILARANG</strong> mengedit atau menghapus kolom <code>id_unit_usaha</code> dan <code>periode</code> agar data tersinkronisasi dengan benar.</li>
                    </ul>
                </div>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card h-100 border shadow-xs">
                            <div class="card-body text-center p-3">
                                ...
                                <p class="small text-muted mb-0">Pilih <strong>Kecamatan</strong> &amp; <strong>Bulan Input</strong> pada filter, lalu klik tombol <strong class="text-success"><i class="fa fa-download"></i> Unduh Template</strong>.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
                        <div class="card h-100 border shadow-xs">
                            <div class="card-body text-center p-3">
                                ...
                                <h6 class="font-weight-bold text-warning">Isi Data Bulanan</h6>
                                <p class="small text-muted mb-0">Buka file Excel, masukkan nominal omset bulanan dan jumlah transaksi/kunjungan. Simpan file (<code>Ctrl+S</code>).</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 mb-3">
...
<!-- ═══ MODAL UPLOAD EXCEL BULANAN ═══ -->
<div class="modal fade" id="modalUpload" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered" style="max-width:480px;">
        <div class="modal-content border-0 shadow-lg">
            <div class="modal-header bg-success text-white py-2">
                <h6 class="modal-title font-weight-bold"><i class="fa fa-file-upload mr-2"></i>Upload File Excel Bulanan Kecamatan</h6>
                <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
            </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="alert alert-warning py-2 small mb-3 border-left" style="border-left: 4px solid #ffc107 !important;">
                        ...
                        <ul class="pl-3 mb-0 text-muted" style="font-size:.78rem;">
                            ...
                            <li><strong>DILARANG</strong> mengubah isi kolom identitas agar data tersinkronisasi.</li>
                        </ul>
                    </div>

                    <div class="form-group mb-2">
                        <label class="small font-weight-bold">Kecamatan Terpilih</label>
                        <input type="text" id="up_label_kecamatan" class="form-control form-control-sm bg-light" readonly>
                    </div>

                    <div class="form-group mb-3">
                        <label class="small font-weight-bold">Periode Bulan Input</label>
                        <input type="text" id="up_label_bulan" class="form-control form-control-sm bg-light" readonly>
                    </div>
